...
function actionsToText(actions, prompt, actionPrefix) {
  var actionsText = prompt || 'Puedes elegir de las siguientes opciones: ';
...
function textMessageToText(resp) {
  ...
  if (resp.actions && resp.actions.length > 0) {
    result = result + actionsToText(resp.actions, 'Puedes elegir de las siguientes opciones: ');
  }
...
function cardsSummaryToText(cards, prompt) {
  var cardsText = prompt || 'Puedes elegir de las siguientes opciones: ';
